...
![android-miniapp1.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/miniapp1.jpg)

![android-miniapp2.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/miniapp2.jpg)
...
3. 发送`/newapp`命令。选择你想要创建小程序的机器人。
   ...
   ![android-miniapp3.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/miniapp3.jpg)
...
4. 为你的小程序提供一个标题、简短的描述和一张图片（尺寸必须为`640`x`360`）。上传预览GIF（发送`/empty`跳过）。
   ...
   ![android-miniapp4.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/miniapp4.jpg)
...
5. 设置小程序打开时显示的URL。设置一个小程序短后缀（`3`~`30`字符），用户将可以使用`t.me/your_robot/short_name`链接直接打开小程序。
   ...
   ![android-miniapp5.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/miniapp5.jpg)
