...
- 手机端：长按选中消息->点击界面右上角三个点
  ...
  ![android-format1.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/format1.jpg)
...
- 电脑端：选中消息->右键->点击`格式`
  ...
  ![desktop-format1.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/desktop/format1.jpg)
...
- 手机端：回复消息->点击输入框上方的回复详情->`选择部分引用`
  ...
  ![android-format2.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/format2.jpg)
...
- 电脑端：鼠标选择需要回复的消息片段->右键->`引用回复`
  ...
  ![desktop-format2.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/desktop/format2.jpg)
...
![android-format3.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/format3.jpg)

![desktop-format3.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/desktop/format3.jpg)
...
![android-format4.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/format4.jpg)
