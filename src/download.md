...
- iOS/macOS/Android客户端：`设置`->`数据`->`存储使用`->`清理缓存`，可以把`媒体文件保留时间`设置短一点，Telegram就会自动清理(3天/1周/1月)之前的缓存，如果选择`永远`就不会自动清理；此处也可以设置`最大缓存大小`。
  ...
  ![android-download1.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/download1.jpg)

  ![android-download2.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/download2.jpg)
...
- Windows/macOS/Linux Desktop 客户端：左上角三短线->`设置`->`高级`->`缓存管理`->`清理缓存`，可以设置缓存总大小的限制。
  ...
  ![desktop-download1.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/desktop/download1.jpg)
...
- iOS/macOS/Android客户端：`设置`->`数据`->`自动下载媒体`
  ...
  ![android-download3.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/android/download3.jpg)
...
- Windows/macOS/Linux Desktop客户端：左上角三短线->`设置`->`高级`->`自动下载媒体`
  ...
  ![desktop-download2.jpg](https://cdn.jsdelivr.net/gh/tgwiki/images/desktop/download2.jpg)
